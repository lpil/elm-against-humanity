...
var _ejlarcs$proverbicam$ExampleTest$tests = A2(
...
var _ejlarcs$proverbicam$Main$tests = A2(
	_elm_community$elm_test$ElmTest$suite,
	'all tests',
	_elm_lang$core$Native_List.fromArray(
		[_ejlarcs$proverbicam$ExampleTest$tests]));
var _ejlarcs$proverbicam$Main$main = {
	main: _elm_community$elm_test$ElmTest$runSuite(_ejlarcs$proverbicam$Main$tests)
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _ejlarcs$proverbicam$Main$main === 'undefined' ? null : _ejlarcs$proverbicam$Main$main);
